...
import com.obsession.app.domain.model.OneRmFormula
...
class ProgressRepository @Inject constructor(
    ...
    fun observePrsForExercise(exerciseId: Long): Flow<List<PersonalRecordEntity>> =
        prDao.observeForExercise(exerciseId)
